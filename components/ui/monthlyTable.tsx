...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-6 px-2 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0', // Reduced height and padding
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'p-2 align-middle [&:has([role=checkbox])]:pr-0 truncate',
      className
